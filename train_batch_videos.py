...
print_every, action_every=10, 50
_CHECKPOINT_PATHS = {
...
def validation_accuracy(n_val_samples,
...
def train_batch_videos(n_iters, save_every=1000,
                        learning_rate=1e-4,
    ...
    with tf.Session().as_default() as sess:
        ...
        videos = resize_tensor(videos, size=(224,224))
...
if __name__=="__main__":
    ...
    best_val_accuracy = train_batch_videos(n_iters,tfrecords_filename=sys.argv[2],
                                            batch_size=16,val_tfrecords=None,
                                            learning_rate=1e-4)
